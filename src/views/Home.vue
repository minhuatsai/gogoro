  ...
  .home-container-footer
    .home-container-footer-article
      .community-container
        ...
        ul
          li(v-for="(listItem,listIndex) in communityData" :key="'community-'+listIndex")
      ...
      .footer-menu-container
        div.menu-section(v-for="(listItem,litIndex) in footerMenu" :key="'menu-section'+listIndex")
          h5
            a {{listItem.title}}
          ul
            li(v-for="(listSecondaryItem,listSecondaryIndex) in listItem.list" :key="'menu-section-'+listItem.title")
              a(:href="listSecondaryItem.href") {{listSecondaryItem.text}}
    .copyright-container
      p Copyright © 2014-2021 Gogoro Inc. All rights reserved.
      a(href="https://www.gogoro.com/privacy-policy/") Privacy Policy
      a(href="https://www.gogoro.com/terms-of-use/") Terms of Use
      div.zone-select-container
        select
          option Region
          option Global
          option Taiwan
